...
import ShopFlexDisplay from "./ShopFlexDisplay";
import ShopGridDisplay from "./ShopGridDisplay";
...
function ShopShowcase() {
    ...
    return (
        <>
            {display === "flex" && <ShopFlexDisplay items={products}/>}
            {display === "grid" && <ShopGridDisplay items={products}/>}
            {display === "list" && <ShopListDisplay items={products}/>}
