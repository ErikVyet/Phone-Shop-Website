...
function SloganSection() {
    ...
    return (
        <motion.div className="w-full h-screen flex flex-col justify-center items-center gap-5" whileInView={{ y: 0, opacity: 1 }} initial={{ y: 15, opacity: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }}>
            <Typography className={`text-5xl! ${theme === "light" ? 'bg-linear-to-r from-blue-500 to-green-400 bg-clip-text text-transparent' : 'text-zinc-100'} text-center`}>Smart Phones. Smarter Choices</Typography>
